...
\begin{frame}[t]{Documentation: why} % {{{2
...
\begin{frame}[t,fragile]{Documentation: internal: comments} % {{{2
...
\begin{frame}[t]{Documentation: internal: comments} % {{{2
	\Huge
	\begin{itemize}
...
\begin{frame}{Documentation: internal: self-documenting code} % {{{2
...
\begin{frame}{Documentation: external} % {{{2
