...
\begin{frame}{Terms of Service: Chosen moments} % {{{3
	...
	\only<1>{
		\begin{quotation}
			...
			to \textbf{access, store and scan} Your Stuff.
		\begin{flushright}
			--- DropBox TOS
		\end{flushright}
		\end{quotation}
	...
	\only<2>{
		\begin{quotation}
			...
			right to \textbf{transmit, use and disclose}
			...
			\textbf{comply with any request} of a
	...
	\only<4>{
		...
		\begin{quotation}
			...
			pre-screen, \textbf{move, refuse, modify and/or
				remove} Content at any time, without
			prior notice and in its sole discretion [\ldots]
		\begin{flushright}
			--- iCloud TOS
		\end{flushright}
		\end{quotation}
	...
	\only<5>{
		...
		\begin{quotation}
			...
			to \textbf{use, distribute, reproduce, modify,
				adapt, publish, translate, publicly
				perform and publicly display} such
	...
	\only<3>{
		\begin{quotation}
			...
			license to \textbf{use, host, store, reproduce,
